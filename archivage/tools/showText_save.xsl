...
doctype-system="about:legacy-compat" indent="yes"/>-->
  ...
  <p class="warning">Le format *.wav n'est pas pris en charge par votre navigateur</p>
       ...
       <!--Affichage des case à cocher pour afficher ou cacher les infos de transcription, traduction pour un texte de type : TEXT-->
        ...
        <table width="100%">
         <tr>
           ...
           <xsl:if test="annot:TEXT/annot:S/annot:FORM[@kindOf='phono'] | annot:WORDLIST/annot:W/annot:FORM[@kindOf='phono']">
       ...
       <td>
         	...
         	<xsl:if test="annot:TEXT/annot:S/annot:FORM[@kindOf='ortho'] | annot:WORDLIST/annot:W/annot:FORM[@kindOf='ortho']">
        ...
        <table>
        	...
        	<td align="center">
         	...
         	<xsl:if test="annot:TEXT/annot:S/annot:FORM[@kindOf='phone'] | annot:WORDLIST/annot:W/annot:FORM[@kindOf='phone']">
          ...
          <table>
        	...
        	<td align="center">	
         	...
         	<xsl:if test="annot:TEXT/annot:S/annot:FORM[@kindOf='transliter'] | annot:WORDLIST/annot:W/annot:FORM[@kindOf='transliter']">
        ...
        <xsl:if test="annot:TEXT/annot:S/annot:FORM[not(@kindOf)] | annot:WORDLIST/annot:W/annot:FORM[not(@kindOf)]">
       ...
       <td>
		...
		<xsl:if test="annot:TEXT/annot:S/annot:TRANSL[@xml:lang='en'] | annot:WORDLIST/annot:W/annot:TRANSL[@xml:lang='en']">
         ...
         <xsl:if test="annot:TEXT/annot:S/annot:TRANSL[@xml:lang='fr'] | annot:WORDLIST/annot:W/annot:TRANSL[@xml:lang='fr']">
         ...
         <table>
            ...
            <xsl:if test="annot:TEXT/annot:S/annot:TRANSL[@xml:lang!='fr' and @xml:lang!='en'] | annot:WORDLIST/annot:W/annot:TRANSL[@xml:lang!='fr' and @xml:lang!='en']">
        ...
        <td>
         ...
         <tr>
          ...
          <xsl:if test="annot:TEXT/annot:S/annot:NOTE | annot:WORDLIST/annot:W/annot:NOTE">
         ...
         <xsl:if test="annot:TEXT/annot:TRANSL| annot:TEXT/annot:S/annot:TRANSL">
         ...
         <td>
            ...
            <xsl:choose>
					<xsl:when test="$aff_lang='fr'">
                       Traduction du texte complet (fr)
                    </xsl:when>
                    <xsl:otherwise> 
                    	Whole text translation (fr)
                    </xsl:otherwise>
             </xsl:choose>
    		 </td>
             	</tr>
            ...
            <xsl:choose>
					<xsl:when test="$aff_lang='fr'">
                       Traduction du texte complet (en)
                    </xsl:when>
                    <xsl:otherwise> 
                    	Whole text translation (en)
                    </xsl:otherwise>
             </xsl:choose>
    		 </td>
             	</tr>
            ...
            <xsl:choose>
					<xsl:when test="$aff_lang='fr'">
                       Traduction du texte complet (other)
                    </xsl:when>
                    <xsl:otherwise> 
                    	Whole text translation (other)
                    </xsl:otherwise>
             </xsl:choose>
    		 </td>
             	</tr>
				...
				<td>
					<table width="100%" border="0" cellpadding="5" cellspacing="0" bordercolor="#993300" class="it">
                       ...
                       <xsl:when test="annot:S/annot:FORM">
                        ...
                        <xsl:when test="annot:S/annot:TRANSL">
                        <tr class="transcriptTable"><td class="segmentInfo"></td><td class="segmentContent"><div class="trad_text_fr"><xsl:for-each select="annot:S"><xsl:value-of select="annot:TRANSL"/><br/></xsl:for-each></div></td></tr>
                        </xsl:when>
                        ...
                        <xsl:when test="annot:S/annot:TRANSL">
                        <tr class="transcriptTable"><td class="segmentInfo"></td><td class="segmentContent"><div class="trad_text_en"><xsl:for-each select="annot:S"><xsl:value-of select="annot:TRANSL"/><br/></xsl:for-each></div></td></tr>
                        </xsl:when>
                        ...
                        <tr class="transcriptTable"><td class="segmentInfo"></td><td class="segmentContent"><div class="trad_text_other"><xsl:for-each select="annot:S"><xsl:value-of select="annot:TRANSL"/><br/></xsl:for-each></div></td></tr>
                        </xsl:when>
