       ...
       <td>
        ...
        <td>
         ...
         <table>
            ...
            <input checked="checked" name="note_info" onclick="javascript:showhide(this, 18, 'block')"  type="checkbox"/>
   			</td>
             </tr>
             </table>
             </td>
              <td>
               ...
               <xsl:if test="annot:TEXT/annot:S/annot:W/annot:M/@class='it'">
               <div><br/><b>
               <xsl:choose>
					<xsl:when test="$aff_lang='fr'">
                                        ...
                                        <xsl:for-each select="annot:W">
                                        	...
                                        	<div class="transcription" >
															<xsl:choose>
																	...
																	<xsl:otherwise>
																		<xsl:choose>
																			<xsl:when test="annot:M/@class='it'">
																				<i>         
