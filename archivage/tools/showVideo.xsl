...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0','width','480','height','360','id','FLVPlayer2','src','../../ecologie/videos_gestion/FLVPlayer_Progressive','flashvars','&MM_ComponentVersion=1&skinName=../../ecologie/videos_gestion/Clear_Skin_2&streamName=../../videos/04_Mahieu&autoPlay=true&autoRewind=false','quality','high','scale','noscale','name','FLVPlayer2','salign','lt','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../../ecologie/videos_gestion/FLVPlayer_Progressive' ); //end AC code
</script><noscript><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="480" height="360" id="FLVPlayer2">
              <param name="movie" value="../../ecologie/videos_gestion/FLVPlayer_Progressive.swf" />
              <param name="salign" value="lt" />
              <param name="quality" value="high" />
              <param name="scale" value="noscale" />
              <param name="FlashVars" value="&MM_ComponentVersion=1&skinName=../../ecologie/videos_gestion/Clear_Skin_2&streamName=../../videos/04_Mahieu&autoPlay=true&autoRewind=false" />
              <embed src="../../ecologie/videos_gestion/FLVPlayer_Progressive.swf" flashvars="&MM_ComponentVersion=1&skinName=../../ecologie/videos_gestion/Clear_Skin_2&streamName=../../videos/04_Mahieu&autoPlay=true&autoRewind=false" quality="high" scale="noscale" width="480" height="360" name="FLVPlayer2" salign="LT" type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" />
</object>
</noscript>
<br>
