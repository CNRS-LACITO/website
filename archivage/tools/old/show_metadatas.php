...
<!-- InstanceBeginEditable name="Contenu" -->
		...
		require_once ('fonctions_Xquery.php');
		  // affichage des metadata du texte interlin�aire sp�cifi� par son id : $id
		  ...
		  try
		  {
			...
			// retourne l'expression Xquery pour l'affichage des metadata du texte selectionn�
			$query= Xquery_text_metadata($id);
			// execute la requete Xquery et affiche le r�sultat
			$db->showResult($query);
