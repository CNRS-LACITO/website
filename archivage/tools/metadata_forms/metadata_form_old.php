...
<table width="100%" height="100%" align="center">
  ...
  <tr>
  <td>
            <strong>Nom du fichier audio que décrit ces métadonnées *</strong><br/>
          		...
          		<table>
           			<tr>
				        ...
				        <span id="sprytextarea1_1">
            				...
            				<span class="textareaRequiredMsg">Une valeur est requise.</span></span> 
            			</td>
           			</tr>
            		<tr>
            			<td>
...
<!--<span id="spryselect1">
	  ...
	  <tr>
  				<td>
					...
					<label>autre langue (code langue)</label>
      ...
      <span id="spryradio1_4">
 					...
 					<label> Données publiques (accessibles à des fins non commerciales) </label>
					<br />
					<input type="radio" name="access"  value="access_no" title="private" id="access_1" />
					<label>Données privées (aucun accès) </label>
					<br />
    ...
    <input name="metadata" type="hidden" title="metadata" value="metadata_text"  />
		<table border="2" width="80%" height="80%" align="center">
  			<tr>
            <td>
            <strong>Nom du fichier d'annotations que décrit ces métadonnées *</strong><br/>
            ...
            <tr>
            <td>
            <strong>Nom du fichier audio auquel le fichier d'annotations est rattaché *</strong><br/>
