 ...
 */
	...
	// le texte interlinéaire est spécifié par son id : $id
	  function Xquery_show_text($id)
	 {
		...
		let  $id_Sound      := "'.$id.'",
			...
			return transform:transform($result,"http://lacito.vjf.cnrs.fr/archivage/tools/show.xsl", $param)
		';
		return $query;
	 }
	...
	// le texte interlinéaire est spécifié par son id : $id
	  function Xquery_text_metadata($id)
	 {
		...
		let  $id_Sound      := "'.$id.'",
			...
			return transform:transform($result,"http://lacito.vjf.cnrs.fr/archivage/tools/meta.xsl", $param)
		';
		return $query;
	 }
	...
	function Xquery_show_MdR($id,$recherche,$niveau,$corpus)
	{
		...
		return transform:transform($result,"http://lacito.vjf.cnrs.fr/archivage/tools/mdr.xsl", $param)
		';
