...
<xsl:stylesheet 
	...
	<xsl:template match="/">
		<result>
			<s_start><xsl:value-of select="//annot:TEXT/annot:S[@id=$num_s]/annot:AUDIO/@start"/></s_start>
            <s_end><xsl:value-of select="//annot:TEXT/annot:S[@id=$num_s]/annot:AUDIO/@end"/></s_end>
            
            <s_form><xsl:value-of select="//annot:TEXT/annot:S[@id=$num_s]/annot:FORM"/></s_form>
            <s_transl><xsl:value-of select="//annot:TEXT/annot:S[@id=$num_s]/annot:TRANSL"/></s_transl>
