...
<table width="100%" height="100%" align="center">
	...
	<tr valign="top">
		<td>
 	 	...
 	 	<form id="form_metadata_sound" name="form_metadata_sound" action="xml_metadata_short.php" method="post">
  ...
  <td>
	...
	<form id="form_metadata_text" name="form_metadata_text" action="xml_metadata_short.php" method="post">
  ...
  <tr>
        ...
        <tr>
	  			<td>
        			<strong>Copyright *</strong>
                    <font color="#FF00FF"> Format : Nom, Prénom </font><br />(du dépositaire ou du responsable de la ressource)<br/>
