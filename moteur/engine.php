...
foreach($var_config_sketuveu as $cle=>$resultat)
	...
	if(empty($resultat))
		{
		erreur_creve("config_incomplete","La variable ".$cle." est vide.<br /> Recherchez la dans le fichier de config et compl&eacute;tez-la pour que le script fonctionne à nouveau.<br />",$engine_version);
		}
	} 
...
$chrono['Etape 1 // V&eacute;rification de la validit&eacute; de la recherche // Temps système']=affiche_chrono_sys($chrono_start_sys); 
/* * * * * * * * * * * * * * * * * * * * * * */
